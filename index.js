     ...
     //  remove Title and description while in cp mode
     ...
     const random = () => {
         ...
         let titleAuthor = document.querySelector('.titleAuthor').setAttribute('id', author);
     };
     random();
     ...
     generateBtn.addEventListener('click', (e) => {
         ...
         const removeAnimate = () => {
             ...
             // random title picker
             //  call random function to generate random title
             random();
         };
